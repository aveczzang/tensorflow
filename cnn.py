...
W_conv1 = weight_variable([5, 5, 1, 32]) # 필터. 5 * 5, 1 : input channel, 32 : output channel
b_conv1 = bias_variable([32]) # 32개 features
...
W_conv2 = weight_variable([5, 5, 32, 64]) # 필터, 5*5, 32개 input, 64개 필터
