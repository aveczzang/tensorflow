...
# third CNN layer 3
# second CNN layer: CONV -> RELU -> POOL
# We use 3x3 patch, accept 32 channel, and produce 64.
...
# Images are reduced to 3x3 and reshaped.
W_fc1 = weight_variable([3 * 3 * 2, 512])
b_fc1 = bias_variable([512])
h_pool2_flat = tf.reshape(h_pool3, [-1, 3 * 3 * 2]) # 1차원 배열로 reshape. dimention은 -1로 하나 줄임.
